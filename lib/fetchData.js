...
export const options = {
  ...
  headers: {
    'X-RapidAPI-Key': 'EXERCISE_API_KEY' , // this is for my main acc starts at 20juil //process.env.EXERCISE_API_KEY,
...
export const YToptions = {
  ...
  headers: {
    'X-RapidAPI-Key': 'a8b28b7f7emsh4226784f1422a58p115bb9jsn19f7d225c8ec',// Same if it's a private key put it in env variables 
