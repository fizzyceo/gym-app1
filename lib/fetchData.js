export const options = {
  ...
  headers: {
    'X-RapidAPI-Key': 'a8b28b7f7emsh4226784f1422a58p115bb9jsn19f7d225c8ec', // ee7ecdb2femsh5d089ef5993b56fp19ca8ejsn16d46977365f 'a8b28b7f7emsh4226784f1422a58p115bb9jsn19f7d225c8ec',this is for my main acc starts at 20juil //process.env.EXERCISE_API_KEY,
...
export const fetchuser = async (session) => {
  const fetchedusers = await fetch(
   `https://gym-app1.vercel.app/api/Users/${session.user.email}`
  );
